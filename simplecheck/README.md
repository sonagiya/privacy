...
본 앱은 특정 연령층이 아닌 **전체 이용자를 대상**으로 하는 서비스입니다.  
앱의 핵심 기능(체크리스트·대시보드·캘린더)은 기기 내에서 동작하며, 개인을 식별하는 정보를 요구하지 않습니다.

- 앱은 아동으로부터 **고의로 개인정보를 수집하지 않습니다.**
- **Google 로그인·백업 기능**은 Google 계정이 필요하며, Google 계정의 생성·이용에는 Google이 정한 최소 연령 요건이 적용됩니다.
- 아동이 앱을 이용하는 경우, 체크리스트 항목명 등에 개인정보를 입력하지 않도록 **보호자의 지도 하에 이용**할 것을 권장합니다.
- 보호자는 아동의 기기에서 앱 삭제 또는 앱 내 데이터 삭제를 통해 관련 정보를 삭제할 수 있습니다.
