...
네트워크 연결은 광고 표시, Google 로그인·백업, 인앱 결제 등 **사용자가 선택하거나 앱이 해당 기능을 제공할 때**에만 필요합니다.
...
| 프리미엄(광고 제거) 상태 | 구매 여부, 상품 ID, 구매 시각 | 기기 내부 저장소 |
...
| Google LLC / Apple Inc. | 인앱 결제 | 구매 영수증·구매 상태 |
